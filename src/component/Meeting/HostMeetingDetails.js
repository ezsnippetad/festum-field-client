            ...
            <div className="relative flex flex-col justify-between h-full px-12">
                <div className="w-full flex items-center sticky top-0 z-20 bg-white py-5">
                    ...
                    <div className="flex items-center space-x-3 ml-auto relative">
                        <span data-tooltip-id="my-tooltip" data-tooltip-content="Add Member"
                              className="inline-block bg-chatlook-sky text-white border border-chatlook-sky rounded-md px-3.5 py-2.5 text-sm font-medium"><i
                            className="icon-plus text-white"></i> Add Member</span>
                    </div>
                </div>
...
export default HostMeetingDetails;