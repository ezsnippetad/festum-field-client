        ...
        <div className="h-full w-full overflow-y-auto py-10 px-4">
          ...
          >
            <div className="flex items-center">
              <div
                onClick={() => {
                  setIsBusinessProfileModalOpen(false); setIsCreatePersonalProfilePopUpOpen(true)
                }}
                    ...
                    <ImagePicker
                      ...
                      onDrop={(files) => {
                        ...
                        if (pdfFiles.length > 0) {
                          ...
                          setUploadedPdfMessage("Brochure Uploaded Successfully")
                          setPdfError("")
                      ...
                      <div className="brochure-main-div h-full w-full">
                        <div className="brochure-div h-full w-full">
                          <div className="flex items-center h-full w-full justify-center">
                            ...
                            {uploadedPdfMessage !== "" ? (<p className="p-2 text-sm text-green-500">{uploadedPdfMessage}</p>) : (<p className="p-2 text-sm">Upload Brochure PDF</p>)}
