...
export default function CreatePersonalProfile({
  // handleClose,
  setEmptyProfilePopUp, setIsCreatePersonalProfilePopUpOpen
}) {
  ...
  const validationSchema = Yup.object({
    ...
    emailId: Yup.string().email("Enter Valid Email Address").required("*Email id require"),
                  ...
                  <div className="w-full md:w-1/2 p-2.5">
                    ...
                    >
                      <Calendar
                        ...
                        dateFormat="dd/mm/yy"
                        onChange={(e) => { setStartDate(e.value); setFieldValue("dob", e.value) }}
                      />
                    </div>
                    {!startDate && (
                      <span className="error-msg-span">
